        ...
        if (
           ...
           !empty($_POST['depart']) 
            ...
            $c = new Logement(
                ...
                $_POST['arrivee'],
                $_POST['depart']);
            $cc->modifierLogement($c,$_GET["id"]); echo'selket';
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="basic-table.html">Ajouter circuit</a></li>
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                   <div class="pull-left">
							<h4 class="text-blue h4">Modifier Logement</h4>
						</div>

                </div>
                <button><a href="gestionlogement.php">Retour à la liste</a></button>
        <hr>
				<?php
			if (isset($_GET['id'])){
				$c = $cc->recupererLogement1($_GET['id']);
		...
		<div id="error">
            <?php echo $error; ?>
				...
				<form  method="POST" action="">
                    ...
                    <td><input type="text" name="hotel" id="hotel"  value = "<?php echo $c->hotel; ?>"></td>
               <td>
                        <input type="date" name="arrivee" id="arrivee"  value = "<?php echo $c->arrivee; ?>">
                    </td>
                <td>
                        <input type="date" name="depart" id="depart" value="<?php echo $c->depart;?>" >
                    </td>
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
			...
			<div class="footer-wrap pd-20 mb-20 card-box">
			Dashboard  <a href="../index.html" target="_blank">Pack'N'Go</a>
			</div>
		</div>
	</div>
	<!-- js -->
