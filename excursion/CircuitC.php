...
class CircuitC{
		...
		function ajouterCircuit1($C){
			$sql="INSERT INTO circuit (destination, depart, information ,tarif,tarif2) VALUES (:destination,:depart,:information, :tarif,:tarif2)";
...
{
    $sql="INSERT INTO reservation (type, date, information,tarif) VALUES (:destination, :depart, :information, :tarif)";
