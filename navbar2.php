            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="logement.php" >Tunisie</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Excursion</a>
                
                <div class="dropdown-menu">
                 
                  <a class="dropdown-item" href="sud.php">Sud</a>
                  <a class="dropdown-item" href="nord.php">Nord</a>
...
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $user['prenom'];echo " ";echo $user['nom']; ?></a>
  
  <div class="dropdown-menu">
    <a class="dropdown-item" href="modifieruser.php">Modifier vos donées</a>
    <!--<a class="dropdown-item" href="testimonials.html">Login in</a>-->
    
    <a class="dropdown-item" href="deconnection.php">Deconnecter</a>
