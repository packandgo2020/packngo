<?PHP
	...
	$listeCirc=$circuitC->afficherReservation();
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Reservation</h4>
                        <p class="mb-30"></p>
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Circuit Reservation</h4>
                        <p></p>
                    </div>
			...
			?>
				<tr>
					...
					<td><?PHP echo $circ['date']; ?></td>
					<td><?PHP echo $circ['information']; ?></td>
					<td><?PHP echo $circ['tarif']; ?></td>

					<td>
						<form method="POST" action="../excursion/supprimerReservation.php">
