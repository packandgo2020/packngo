        ...
        <div class="min-height-200px">
			...
			?>
				<tr>
					...
					<td><?PHP echo $circ['hotel']; ?></td>
					<td><?PHP echo $circ['arrivee']; ?></td>
					<td><?PHP echo $circ['depart']; ?></td>
					<td><img src="imge/<?PHP echo $circ['photo'];?>" height="200" widh="200"></td>
					<td><?PHP echo $circ['typee']; ?></td>

					<td>
						<form method="POST" action="../logement/supprimerLogement.php">
					...
					<td>
						<a href="modifierlogement2.php?id=<?PHP echo $circ['id']; ?>"> Modifier </a>
					</td>
				</tr>
			<?PHP
				}
